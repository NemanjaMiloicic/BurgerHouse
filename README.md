...
BurgerHouse je web aplikacija rađena u c# .netu i reactjs kao bazu koristi redis iz dockera. Aplikacija nude:

- Prijava i odjava.
- Meni sa hranom i pićem.
- Online uplaćivanje novca na web aplikaciju putem Payala i naručivanje stavki iz menija i pregled obrađenih narudžbina (RealTime).
